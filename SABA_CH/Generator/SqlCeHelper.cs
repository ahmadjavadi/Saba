...
#endif
    {
        ...
        public void SaveDataConnection(string repositoryConnectionString, string connectionString, string filePath, int dbType)
        {
            using (var cmd = new SqlCeCommand(repositoryConnectionString))
            {
                ...
                cmd.Parameters.Add("@Source", SqlDbType.NVarChar, 2048);
                cmd.Parameters.Add("@FileName", SqlDbType.NVarChar, 512);
                cmd.Parameters.Add("@CeVersion", SqlDbType.Int);
        ...
        public bool IsV40Installed()
        {
            ...
            {
                MessageBox.Show(FI.Message);
                return false;
            }
            catch (FileLoadException FI)
            {
                MessageBox.Show(FI.Message);
                return false;
            }
