...
namespace SABA_CH.DataBase
{
    ...
    public partial class SabaNewEntities : DbContext
    {
        public SabaNewEntities()
            : base("name=SabaNewEntities")
        {
        }
        ...
        public DbSet<AnnualCredit> AnnualCredits { get; set; }
        public DbSet<Area> Areas { get; set; }
        public DbSet<Button> Buttons { get; set; }
        public DbSet<Card> Cards { get; set; }
        public DbSet<Catchment> Catchments { get; set; }
        public DbSet<ChangeDB> ChangeDBs { get; set; }
        public DbSet<City> Cities { get; set; }
        public DbSet<Country> Countries { get; set; }
        public DbSet<CreateTokenByDongle> CreateTokenByDongles { get; set; }
        public DbSet<Credit> Credits { get; set; }
        public DbSet<Curve> Curves { get; set; }
        public DbSet<Customer> Customers { get; set; }
        public DbSet<DangelInfo> DangelInfoes { get; set; }
        public DbSet<DataBasesInfo> DataBasesInfoes { get; set; }
        public DbSet<DeviceModel> DeviceModels { get; set; }
        public DbSet<DeviceType> DeviceTypes { get; set; }
        public DbSet<EOffice> EOffices { get; set; }
        public DbSet<Error> Errors { get; set; }
        public DbSet<ESubOffice> ESubOffices { get; set; }
        ...
        public DbSet<MeterShutdownInterval> MeterShutdownIntervals { get; set; }
        public DbSet<Modem> Modems { get; set; }
        public DbSet<OBISS> OBISSes { get; set; }
        public DbSet<OBISType> OBISTypes { get; set; }
        public DbSet<OBISUnit> OBISUnits { get; set; }
        public DbSet<OBISValueDetail> OBISValueDetails { get; set; }
        public DbSet<OBISValueHeader> OBISValueHeaders { get; set; }
        public DbSet<Office> Offices { get; set; }
        public DbSet<OldOBISs> OldOBISses { get; set; }
        public DbSet<Plain> Plains { get; set; }
        public DbSet<Province> Provinces { get; set; }
        public DbSet<regulationRule> regulationRules { get; set; }
        public DbSet<Report> Reports { get; set; }
        public DbSet<SoftversionToDeviceModel> SoftversionToDeviceModels { get; set; }
        public DbSet<SourceType> SourceTypes { get; set; }
        public DbSet<SubOffice> SubOffices { get; set; }
        public DbSet<sysdiagram> sysdiagrams { get; set; }
        public DbSet<Token> Tokens { get; set; }
        public DbSet<TokenFromDangle> TokenFromDangles { get; set; }
        public DbSet<Translate> Translates { get; set; }
        public DbSet<UnitGroup> UnitGroups { get; set; }
        public DbSet<User> Users { get; set; }
        public DbSet<VeeConsumedWater> VeeConsumedWaters { get; set; }
        public DbSet<Window> Windows { get; set; }
        public DbSet<ButtonAccess> ButtonAccesses { get; set; }
        public DbSet<CardToMeter> CardToMeters { get; set; }
        public DbSet<ConsumedActiveEnergy> ConsumedActiveEnergies { get; set; }
        public DbSet<ConsumedMaxDemand> ConsumedMaxDemands { get; set; }
        public DbSet<ConsumedWater> ConsumedWaters { get; set; }
        public DbSet<Credit303> Credit303 { get; set; }
        public DbSet<FixedOBI> FixedOBIS { get; set; }
        public DbSet<GroupToProvince> GroupToProvinces { get; set; }
        public DbSet<HashToGroup> HashToGroups { get; set; }
        public DbSet<MeterToCustomer> MeterToCustomers { get; set; }
        public DbSet<MeterToGroup> MeterToGroups { get; set; }
        public DbSet<MonthName> MonthNames { get; set; }
        public DbSet<OBISToReport> OBISToReports { get; set; }
        public DbSet<OBISToSoftversion> OBISToSoftversions { get; set; }
        public DbSet<ObjectofWindow> ObjectofWindows { get; set; }
        public DbSet<RegionalOffice> RegionalOffices { get; set; }
        public DbSet<StatusOBISsDesc> StatusOBISsDescs { get; set; }
        public DbSet<TempMeter1> TempMeter1 { get; set; }
        public DbSet<TempSaba> TempSabas { get; set; }
        public DbSet<UserToGroup> UserToGroups { get; set; }
        public DbSet<AccessUserToMeter> AccessUserToMeters { get; set; }
        public DbSet<GroupsMeter> GroupsMeters { get; set; }
        public DbSet<MaxReadDateView> MaxReadDateViews { get; set; }
        public DbSet<MeterErrorView> MeterErrorViews { get; set; }
        ...
        public virtual int DelVeeConsumedWater(Nullable<decimal> customerid, Nullable<decimal> meterId, string startDate, string endDate, ObjectParameter errMSG)
        {
            var customeridParameter = customerid.HasValue ?
                new ObjectParameter("customerid", customerid) :
                new ObjectParameter("customerid", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DelVeeConsumedWater", customeridParameter, meterIdParameter, startDateParameter, endDateParameter, errMSG);
        }
        ...
        public virtual int ImportFromSabaCandHNew(Nullable<decimal> userID, Nullable<decimal> sabaCandHID, Nullable<decimal> groupID, Nullable<decimal> groupType, ObjectParameter result, string errMSG)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(decimal));

            var sabaCandHIDParameter = sabaCandHID.HasValue ?
                new ObjectParameter("SabaCandHID", sabaCandHID) :
                new ObjectParameter("SabaCandHID", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ImportFromSabaCandHNew", userIDParameter, sabaCandHIDParameter, groupIDParameter, groupTypeParameter, result, errMSGParameter);
        }
        ...
        public virtual int UPDOBISValueDetailAfterins(string cardNumber, Nullable<decimal> oBISValueHeaderID, Nullable<bool> isDuplicateData, ObjectParameter result, ObjectParameter errMSG)
        {
            var cardNumberParameter = cardNumber != null ?
                new ObjectParameter("CardNumber", cardNumber) :
                new ObjectParameter("CardNumber", typeof(string));
            ...
            var isDuplicateDataParameter = isDuplicateData.HasValue ?
                new ObjectParameter("IsDuplicateData", isDuplicateData) :
                new ObjectParameter("IsDuplicateData", typeof(bool));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UPDOBISValueDetailAfterins", cardNumberParameter, oBISValueHeaderIDParameter, isDuplicateDataParameter, result, errMSG);
        }
        ...
        public virtual int InsMeterShutdownInterval(Nullable<decimal> meterId, string startDate, string endDate, Nullable<decimal> userID, Nullable<int> numberOfMonths, string defineDate, ObjectParameter result, ObjectParameter eRRMSG)
        {
            var meterIdParameter = meterId.HasValue ?
                new ObjectParameter("MeterId", meterId) :
                new ObjectParameter("MeterId", typeof(decimal));
            ...
            var numberOfMonthsParameter = numberOfMonths.HasValue ?
                new ObjectParameter("NumberOfMonths", numberOfMonths) :
                new ObjectParameter("NumberOfMonths", typeof(int));
    
            var defineDateParameter = defineDate != null ?
                new ObjectParameter("DefineDate", defineDate) :
                new ObjectParameter("DefineDate", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsMeterShutdownInterval", meterIdParameter, startDateParameter, endDateParameter, userIDParameter, numberOfMonthsParameter, defineDateParameter, result, eRRMSG);
        }
        ...
        public virtual int INSVeeConsumedWater(Nullable<decimal> meterID, Nullable<decimal> customerId, string consumedDate, string flow, string monthlyConsumption, string totalConsumption, Nullable<bool> isValid, ObjectParameter result, ObjectParameter errMSG)
        {
            var meterIDParameter = meterID.HasValue ?
                new ObjectParameter("MeterID", meterID) :
                new ObjectParameter("MeterID", typeof(decimal));
            ...
            var flowParameter = flow != null ?
                new ObjectParameter("Flow", flow) :
                new ObjectParameter("Flow", typeof(string));
    
            var monthlyConsumptionParameter = monthlyConsumption != null ?
                new ObjectParameter("MonthlyConsumption", monthlyConsumption) :
                new ObjectParameter("MonthlyConsumption", typeof(string));
    
            var totalConsumptionParameter = totalConsumption != null ?
                new ObjectParameter("TotalConsumption", totalConsumption) :
                new ObjectParameter("TotalConsumption", typeof(string));
    
            var isValidParameter = isValid.HasValue ?
                new ObjectParameter("IsValid", isValid) :
                new ObjectParameter("IsValid", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("INSVeeConsumedWater", meterIDParameter, customerIdParameter, consumedDateParameter, flowParameter, monthlyConsumptionParameter, totalConsumptionParameter, isValidParameter, result, errMSG);
        }
        ...
        public virtual ObjectResult<ShowConsumedWaterForVee303_Result> ShowConsumedWaterForVee303(string filter)
        {
            var filterParameter = filter != null ?
                new ObjectParameter("Filter", filter) :
                new ObjectParameter("Filter", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ShowConsumedWaterForVee303_Result>("ShowConsumedWaterForVee303", filterParameter);
        }
        ...
        public virtual ObjectResult<ShowTranslate_Result> ShowTranslate(string filter)
        {
            var filterParameter = filter != null ?
                new ObjectParameter("Filter", filter) :
                new ObjectParameter("Filter", typeof(string));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ShowTranslate_Result>("ShowTranslate", filterParameter);
        }
        ...
        public virtual ObjectResult<ShowMeterForVEE_Result> ShowMeterForVEE(string filter)
        {
            var filterParameter = filter != null ?
                new ObjectParameter("Filter", filter) :
                new ObjectParameter("Filter", typeof(string));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ShowMeterForVEE_Result>("ShowMeterForVEE", filterParameter);
        }
        ...
        public virtual ObjectResult<ShowMeterShutdownInterval_Result> ShowMeterShutdownInterval(Nullable<decimal> meterId, ObjectParameter result, ObjectParameter eRRMSG)
        {
            var meterIdParameter = meterId.HasValue ?
                new ObjectParameter("MeterId", meterId) :
                new ObjectParameter("MeterId", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ShowMeterShutdownInterval_Result>("ShowMeterShutdownInterval", meterIdParameter, result, eRRMSG);
        }
        ...
        public virtual ObjectResult<ShowVeeConsumedWater_Result> ShowVeeConsumedWater(Nullable<decimal> meterId)
        {
            var meterIdParameter = meterId.HasValue ?
                new ObjectParameter("meterId", meterId) :
                new ObjectParameter("meterId", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ShowVeeConsumedWater_Result>("ShowVeeConsumedWater", meterIdParameter);
        }
        ...
        public virtual int UPDVeeConsumedWater()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UPDVeeConsumedWater");
        }
    }
}
