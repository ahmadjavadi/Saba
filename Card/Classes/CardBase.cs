...
{/// <summary>
    ...
    /// </summary>
    internal class SCARD_ATTR_VALUE
    {
        private const uint
    ...
    /// </summary>
    internal delegate void CardInsertedEventHandler();

    /// <summary>
    /// Delegate for the CardRemoved event
    /// </summary>
    internal delegate void CardRemovedEventHandler();

    /// <summary>
    /// Abstract class that adds a basic event management to the ICard interface. 
    /// </summary>
    abstract internal class CardBase : ICard
    {
