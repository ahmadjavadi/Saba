            ...
            try
            {
                ...
                switch (convertRule)
                {
                    ...
                    case "8":
                        ...
                        try
                        {
                            pd = new FarsiLibrary.Utils.PersianDate(year, month, day, 0, 0, 0);

                            // if (pd.Compare(FarsiLibrary.Utils.PersianDate.Now, pd) > 0)
                            value = FarsiLibrary.Utils.PersianDateConverter.ToGregorianDateTime(pd).ToString();
                            // else
